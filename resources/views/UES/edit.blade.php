            ...
            <div class="col-6 offset-3">
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title fw-bold">Modifier une UE</h2>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form method="POST" action="{{ route('UES.update', $UE) }}">
                            @csrf
                            @method('PUT')
                        
                                <div class="col-12 my-2">
                                    <label for="libelle" class="label-form">Libelle</label>
                                    <input type="text" class="form-control" name="libelle" value="{{$UE->libelle}}" required>
                                </div>
                                <div class="col-12 my-2">
