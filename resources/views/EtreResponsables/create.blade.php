                    ...
                    <div class="col-6 offset-3">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title fw-bold fs-3">Creer une Responsable</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form method="POST" action="{{ route('EtreResponsables.store') }}">
                                     @csrf
                                     ...
                                     <div class="my-3">
                                        ...
                                        <input type="year" class="form-control" name="annee" id="annee" required>
                                     </div>
                                     <div class="my-3">
