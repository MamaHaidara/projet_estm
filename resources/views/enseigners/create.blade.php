                    ...
                    <div class="col-6 offset-3">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Creer un enseignement</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form method="POST" action="{{ route('enseigners.store') }}">
                                    @csrf
                                    ...
                                    <div class="col-12 my-2">
                                        <input type="year" class="form-control" name="annee" required>
                                    </div>
                                    <div class="col-12 my-2">
