            ...
            <div class="col-6 offset-3">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Modifier un EC</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form method="POST" action="{{ route('ECS.update', $EC) }}">
                            @csrf
                            @method('PUT')
                            <div class="col-12 my-2">
                                <label for="">Nom EC</label>
                                <input type="text" class="form-control" name="libelle" value="{{$EC->libelle}}" required>
                            </div> 
                            <div class="col-12 my-2">
